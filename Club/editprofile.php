...
<div id="page-wrapper">
   ...
   <?php
        $sql2="select * from club where userid=$userid";
    ...
    <form method="POST" action="updateprofile.php">
        ...
        <input type='text' class='form-control' name='clubname' value='<?php echo $r2['clubname']?>' required>
        </div>
        <div class='col-md-6'>
        <label>Place</label>
        ...
        <div class='col-md-6'>
        <label>state</label>
        <input type='text' class='form-control' name='state' value='<?php echo $r2['state']?>' required>
        </div>
